<template>
    <dialog ref="deleteExpenseDialog" id="deleteExpenseDialog" class="modal">
        <div class="modal-box">
            ...
            <p class="py-4">Quer realmente deletar a despesa <b>"{{ selectedExpense?.name }}"</b> da lista de despesas?
            </p>

            <button class="btn btn-primary btn-block" @click="() => destroy(selectedExpense.id)">Sim, quero
                deletar</button>
